...
namespace UnityEngine.InputSystem.Samples.RebindUI {
    ...
    public class RebindActionUI : MonoBehaviour {
        ...
        private void ResetBinding(InputAction action, int bindingsIndex) {
            InputBinding newBinding = action.bindings[bindingsIndex];
            string oldOverridePath = newBinding.overridePath;

            action.RemoveBindingOverride(bindingsIndex);
        ...
        [Tooltip("What text should be displayed for the action label")] [SerializeField]
